...
module sopc_nios2_gen2_0 (
		...
		output wire        debug_ack,                           //             debug_conduit.debug_ack
		input  wire        debug_req                            //                          .debug_req
	);

	sopc_nios2_gen2_0_cpu cpu (
		.clk                                 (clk),                                 //                       clk.clk
		...
		.debug_ack                           (debug_ack),                           //             debug_conduit.debug_ack
		.debug_req                           (debug_req)                            //                          .debug_req
	);
