...
module sopc_alt_vip_cl_vfb_0 #(
		...
		parameter MEM_BASE_ADDR                = 16777216,
		...
		parameter DROP_FRAMES                  = 0,
		parameter REPEAT_FRAMES                = 0,
		...
		output wire [5:0]   mem_master_wr_burstcount,    //              .burstcount
		input  wire         mem_master_wr_waitrequest,   //              .waitrequest
		output wire         mem_master_wr_write,         //              .write
		output wire [255:0] mem_master_wr_writedata,     //              .writedata
		output wire [31:0]  mem_master_wr_byteenable,    //              .byteenable
	...
	sopc_alt_vip_cl_vfb_0_video_in video_in (
	...
	alt_vip_packet_transfer #(
		...
		.MAX_PACKET_SIZE_WRITE             (480000),
		.MAX_PACKET_NUM_WRITE              (1),
		.MAX_CONTEXT_NUMBER_WRITE          (1),
		.CONTEXT_BUFFER_RATIO_WRITE        (2),
		.BURST_TARGET_WRITE                (32),
		.COMB_OUTPUT_WRITE                 (0),
